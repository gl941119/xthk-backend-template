...
export default {
    ...
    data() {
        return {
            ...
            currentPage: {
                current: 1,
                pageSize:
                    typeof this.pageSettings !== 'boolean'
    ...
    methods: {
        ...
        pageChange(pagination, filters, sorter) {
            if (
                this.currentPage.pageSize !== pagination.pageSize ||
            ...
            if (
                this.currentSorted.filed !== sorter.filed ||
                this.currentSorted.order !== sorter.order
            ) {
